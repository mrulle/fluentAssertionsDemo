...
namespace Exercises
{
    public class Ex02_DateTimeTests
    {
        ...
        public void In_2023_Easter_Sunday_Falls_On_April_9th()
        {
            ...
            // Assert
            date.Should().NotBe(null).And.BeSameDateAs(expected);
        ...
        public void The_start_of_this_presentation_is_within_5_minutes_of_the_scheduled_time()
        {
            ...
            // Assert
            //date.Should().NotBe(null).And.BeWithin(5.Minutes()).(expectedStartOfLecture);
            date.Should().NotBe(null).And.BeCloseTo(expectedStartOfLecture, 5.Minutes());
